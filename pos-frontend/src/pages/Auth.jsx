  ...
  return (
    <section className="w-screen h-full flex flex-col items-center justify-center">
      ...
      <form className="h-fit sm:w-fit w-full bg-custom-bg-2 rounded-2xl px-12 py-16 flex flex-col items-center justify-center">
        ...
        <div className="text-sm mt-6 hidden sm:block">Please enter your credentials below to continue</div>
        ...
        <div className="sm:w-[450px] w-[280px] mt-7 flex flex-col items-start">
        ...
        <div className="w-full h-fit flex flex-col justify-center items-center sm:flex-row sm:justify-between mt-3">
          ...
          <div className="text-[11.5px] w-[280px] sm:w-fit underline" >Forgot Password?</div>
        </div>
